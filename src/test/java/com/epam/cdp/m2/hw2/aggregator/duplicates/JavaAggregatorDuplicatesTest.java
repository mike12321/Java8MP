...
public abstract class JavaAggregatorDuplicatesTest {
    ...
    public static List<Object[]> data() {
        ...
        data.add(new Object[]{3, asList("wwwoooo", "a", "BA", "wwwoOoo", "ba"), asList("WWWOOOO", "BA")});
        data.add(new Object[]{3, asList("all", "arguments", "a", "map", "wwwwwww", "map", "arguments", "all"), asList("MAP", "ARGUMENTS", "ALL")});
